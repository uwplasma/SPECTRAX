...
Checkpointed JAX gradients and a constrained electron-tail optimization example
are described in [differentiable particle energization](docs/particle_acceleration.md).
